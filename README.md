...
| :--- | :--- | :--- |
| **[Sovyren](https://sovyren.com)** | AI business automation and strategy consultancy. | Next.js, n8n, OpenAI |
| **[Vera](https://usevera.cloud)** | High-performance operations management platform. | React, Supabase, Stripe |
| **[Essentials](https://useessentials.cloud)** | Productivity tools for modern businesses. | Next.js, Mantine, Shadcn UI |
| **[Raintree Irrigation](https://raintreeirrigation.com)** | Scheduling and management platform for service providers. | React, Supabase, clearly |
